...
const rules_modal = [{
  ...
  ruleSelector: '.input-email-modal',
  rules: [{
    rule: 'email',
    errorMessage: 'Некорректный email'
  }, {
...
function handleModalClicked() {
  dialog.showModal();
  (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)('.form-modal', rules_modal, afterForm);
}
...
if (!dialog?.hasAttribute('open')) {
  (0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_3__.validateForms)('.form-page', rules_page, afterForm);
}
...
const disableScroll = () => {
  ...
  const paddingOffset = `${window.innerWidth - (_vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.offsetWidth)}px`;
  (_vars__WEBPACK_IMPORTED_MODULE_0___default().htmlEl.style.scrollBehavior) = 'none';
  fixBlocks.forEach(el => {
    el.style.paddingRight = paddingOffset;
  });
  (_vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.style.paddingRight) = paddingOffset;
  _vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.classList.add('dis-scroll');
  (_vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.dataset.position) = pagePosition;
  (_vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.style.top) = `-${pagePosition}px`;
};
...
const enableScroll = () => {
  ...
  const pagePosition = parseInt((_vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.dataset.position), 10);
  fixBlocks.forEach(el => {
    el.style.paddingRight = '0px';
  });
  (_vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.style.paddingRight) = '0px';
  (_vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.style.top) = 'auto';
  _vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.classList.remove('dis-scroll');
  window.scroll({
    top: pagePosition,
    left: 0
  });
  _vars__WEBPACK_IMPORTED_MODULE_0___default().bodyEl.removeAttribute('data-position');
  (_vars__WEBPACK_IMPORTED_MODULE_0___default().htmlEl.style.scrollBehavior) = 'smooth';
};
...
const validateForms = (selector, rules, afterSend) => {
  ...
  validation.onSuccess(ev => {
    ...
    xhr.open('POST', 'https://inteltone.ru/ventforum_mail.php', true);
    xhr.send(formData);
    ev.target.reset();
    function removeSuccessMessage() {
      const success_message = document?.querySelector('.success-message');
      success_message.parentElement.classList.remove('success--active');
      success_message.remove();
    }
    if (document?.querySelector('dialog').hasAttribute('open')) {
      let success_modal = document.querySelector('.success-modal');
      success_modal.insertAdjacentHTML('beforeend', '<p class="success-message">Ваше сообщение успешно отправлено. Мы свяжемся с Вами в ближайшее время.</p>');
      success_modal.classList.add('success--active');
      setTimeout(removeSuccessMessage, 10000);
    } else {
      let success_page = document.querySelector('.success-page');
      success_page.insertAdjacentHTML('beforeend', '<p class="success-message">Ваше сообщение успешно отправлено. Мы свяжемся с Вами в ближайшее время.</p>');
      success_page.classList.add('success--active');
      setTimeout(removeSuccessMessage, 10000);
    }
  });
};
...
if (check_systems_slider) {
  ...
  var systems_slider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('.systems-slider', {
    type: 'loop',
    autoplay: true,
    interval: 8000,
    speed: 7000,
...
if (check_cases_slider) {
  ...
  var cases_slider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('.cases-slider', {
    type: 'loop',
    perPage: 6,
    focus: 0,
    arrows: false,
...
if (check_marquee) {
  ...
  var marquee = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('.marquee', {
    type: 'loop',
    drag: 'free',
    focus: 'center',
    autoWidth: true,
...
if (check_marquee_2) {
  ...
  var marquee_2 = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('.marquee-2', {
    type: 'loop',
    drag: 'free',
    focus: 'center',
    autoWidth: true,
...
if (check_case_slider) {
  ...
  var case_slider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('#case-slider', {
    type: "loop",
    pagination: false,
    classes: {
...
const checkbox_page = document.querySelector('.checkbox-page');
const btn_submit_page = document.querySelector('.btn-submit-page');
if (checkbox_page) {
  function handleBtnSubmitClicked(e) {
    e.preventDefault();
  }
  checkbox_page.addEventListener('change', event => {
    if (!event.currentTarget.checked) {
      btn_submit_page.classList.add('btn--inactive');
      btn_submit_page.addEventListener('click', handleBtnSubmitClicked, false);
      // console.log("кнопка не работает")
    } else {
      btn_submit_page.classList.remove('btn--inactive');
      btn_submit_page.removeEventListener('click', handleBtnSubmitClicked, false);
      // console.log("кнопка работает")
    }
  });
}

const checkbox_modal = document.querySelector('.checkbox-modal');
const btn_submit_modal = document.querySelector('.btn-submit-modal');
if (checkbox_modal) {
  function handleBtnSubmitClicked(e) {
    e.preventDefault();
  }
  checkbox_modal.addEventListener('change', event => {
    if (!event.currentTarget.checked) {
      btn_submit_modal.classList.add('btn--inactive');
      btn_submit_modal.addEventListener('click', handleBtnSubmitClicked, false);
    } else {
      btn_submit_modal.classList.remove('btn--inactive');
      btn_submit_modal.removeEventListener('click', handleBtnSubmitClicked, false);
    }
  });
}
...
// const popup_open_btn = document?.querySelector(".popup-open")
// const close_btn = document?.querySelector(".close-btn")
// const dialog = document?.querySelector("dialog")

// popup_open_btn?.addEventListener('click', () => {
//   dialog?.show()
// })
// dialog?.addEventListener("click", e => {
//   const dialogDimensions = dialog.getBoundingClientRect()
